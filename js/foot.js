...
module.exports = function() {
  var init, pauseVid, playVid, played, player, video;
  video = {};
  played = false;
  player = {};
  playVid = function() {
  ...
  init = function(modal) {
    ...
    return CSSModal.on('cssmodal:hide', document, pauseVid);
  };
  return $(function() {
    return init(CSSModal);
  });
};


},{"froogaloop":8,"modal":4}],2:[function(require,module,exports){
module.exports = function() {
  var carousel, teamControls;
  ...
  return teamControls.bind('click', function(e) {
...
},{"./autoplayVideo":1,"./carouselInit":2,"carousel":6,"jquery":5,"retina":7}],4:[function(require,module,exports){
(function (global){
...
; browserify_shim__define__module__export__(typeof CSSModal != "undefined" ? CSSModal : window.CSSModal);
...
; browserify_shim__define__module__export__(typeof $f != "undefined" ? $f : window.$f);
